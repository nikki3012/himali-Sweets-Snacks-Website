        ...
        <div class="container">
          <div class="row mb-5">
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="swiper product-slider">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" target="_blank" href="<?php echo $products_data[0]["product_img"] ?>" data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid" src="<?php echo $products_data[0]["product_img"] ?>" alt="..."></a></div>
            ...
            <div class="col-lg-6">
              ...
              <h1> <?php echo $products_data[0]["product_name"] ?></h1>
              <p class="text-muted lead">₹<?php echo $products_data[0]["product_price"] ?></p>
              <p class="text-sm mb-4"><?php echo $products_data[0]["product_description"] ?></p>
